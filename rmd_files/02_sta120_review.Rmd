...
```{r, include=FALSE}
library(tidyverse)
food_expanded <- read_csv("https://bit.ly/2UD4cMm")
```
...
ggplot(data = food_expanded, aes(income, food_exp)) + 
...
<!--\# Instructions**Preliminary Steps:**Open R and create a new R script.In the Environment tab in the upper-right corner, click Import Dataset and then click From Text (readr).Find cf.csv by clicking Browse. Once you find it click Import.If the data frame doesn't automatically appear, then type `View(cf_df)` into the console to view the data.Instructions**Preliminary Steps:**Open R and create a new R script.In the Environment tab in the upper-right corner, click Import Dataset and then click From Text (readr).Find cf.csv by clicking Browse. Once you find it click Import.If the data frame doesn't automatically appear, then type `View(cf_df)` into the console to view the data.-->
